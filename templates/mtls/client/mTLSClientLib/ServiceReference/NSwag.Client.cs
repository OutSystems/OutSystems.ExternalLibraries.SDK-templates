...
namespace mTLSclient {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    internal partial class ExampleClient : ExampleClientBase, IExampleClient {
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    [OSStructure]
    public partial struct WeatherForecast {
        [Newtonsoft.Json.JsonConstructor]

        public WeatherForecast(DateTime? @date, string? @summary, int? @temperatureC, int? @temperatureF) {
